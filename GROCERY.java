...
public class GROCERY {
	...
	//	   capabilities.setCapability("marionette",true);
		   ...
		   WebElement searchBox=driver.findElement(By.cssSelector(("#twotabsearchtextbox")));
	        searchBox.sendKeys("oyster sauce vegetarian");
	        WebElement searchButton=driver.findElement(By.cssSelector((".nav-search-submit")));
	        searchButton.click();
	        WebElement pricetag=driver.findElement(By.cssSelector(("#search > div.s-desktop-width-max.s-desktop-content.sg-row > div.sg-col-20-of-24.sg-col-28-of-32.sg-col-16-of-20.sg-col.s-right-column.sg-col-32-of-36.sg-col-8-of-12.sg-col-12-of-16.sg-col-24-of-28 > div > span:nth-child(5) > div.s-result-list.s-search-results.sg-row > div:nth-child(2) > div > span > div > div > div > div > div:nth-child(4) > div > div > a > span:nth-child(1) > span:nth-child(2) > span.a-price-whole")));
	        pricetag.click();
